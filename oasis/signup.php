        ...
        if(!preg_match('/^[A-Za-z]{1}[A-Za-z0-9]{5-31}$/',$username)){
            ...
            if(mysqli_num_rows($result)>0){
                ...
                if(mysqli_num_rows($result)>0){
                    ...
                    $sql = "INSERT INTO users (username,email,password,created_at) VALUES ('$username','$email','$password','$created')";
