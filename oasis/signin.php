...
<body class="grid md:grid-cols-2  border-box h-screen">
    ...
    <div>
    <div class="">
    <form action="signin.php" class="w-80 mx-auto mb-14" method="POST">
        ...
        <input type="email" name="email" id="" class="block py-3 px-3 bg-gray-300 rounded-md w-full" placeholder="E-mail address">
        <input type="password" name="password" id="" class="block py-3 bg-gray-300 px-3 mt-3 rounded-md w-full" placeholder="Password">
        <a href="" class="text-md mt-2 block text-right">Forgot password?</a>
        <button class="w-36 rounded-full py-3 text-white bg-gray-800 block text-center mx-auto mt-4" name="submit">Sign in</button>
    </form>
    <p class="text-center text-md">New user? <a href="signup.php" class="text-gray-400 underline "> Create account</a></p>
    </div>
    </div>
</body>
</html>